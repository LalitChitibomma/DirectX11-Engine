...
void Cd3D::GetProjectionMatrix(XMMATRIX& projectionMatrix)
{
...
void Cd3D::GetWorldMatrix(XMMATRIX& worldMatrix)
{
...
void Cd3D::GetOrthoMatrix(XMMATRIX& orthoMatrix)
{
...
void Cd3D::SetBackBufferRenderTarget()
{
	// Bind the render target view and depth stencil buffer to the output render pipeline.
	m_deviceContext->OMSetRenderTargets(1, &m_renderTargetView, m_depthStencilView);
